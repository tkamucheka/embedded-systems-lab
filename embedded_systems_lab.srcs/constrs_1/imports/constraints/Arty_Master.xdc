...
## PWM signal
#set_property -dict { PACKAGE_PIN P18    IOSTANDARD LVCMOS33 } [get_ports { pwm[0] }]; # using IO40 for this signal
#set_property -dict { PACKAGE_PIN N17    IOSTANDARD LVCMOS33 } [get_ports { pwm[1] }]; # using IO41 for this signal
